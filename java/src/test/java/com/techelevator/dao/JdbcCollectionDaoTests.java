...
public class JdbcCollectionDaoTests extends BaseDaoTests{
    ...
    private static final Collection COLLECTION_1 = new Collection(1, "testCollection1", 1, true);
    private static final Collection COLLECTION_2 = new Collection(2, "testCollection2", 2, false);
    private static final Collection COLLECTION_3 = new Collection(3, "testCollection3", 3, true);
    ...
    public void getCollectionById_returns_correct_collection_for_id(){
        Collection collection = sut.getCollectionById(1);
        assertCollectionsMatch(COLLECTION_1, collection);


        collection = sut.getCollectionById(1);
    ...
    public void getCollectionByUserId_returns_correct_collection_for_id(){
        List<Collection> collections = sut.getCollectionsByUserId(1);
        ...
        collections = sut.getCollectionsByUserId(2);
    ...
    public void updated_collection_has_expected_values_when_retrieved(){
        Collection collectionToUpdate = sut.getCollectionById(1);
        ...
        Collection retrieveCollection = sut.getCollectionById(1);
        assertCollectionsMatch(collectionToUpdate, retrieveCollection);
    }

    @Test
    public void addComicToCollection_returns_expected_value(){
        sut.addComicToCollection(122, "Oh neat a comic", "imageURLTHINGY", "This description is a description", 1);
